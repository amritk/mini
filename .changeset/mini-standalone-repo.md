...
Move `@amritk/mini` and `@amritk/mini-native` out of the [mjst](https://github.com/amritk/mjst) monorepo into their own repository at [amritk/mini](https://github.com/amritk/mini).
