...
First release of `@amritk/mini-lynx`: a signals runtime **for Lynx**, driving
...
`docs/mini-lynx-runtime.md`; `AI.md` and the README carry the current *Known
gaps* (`<list>` does not recycle, no `SelectorQuery` wrapper, gesture composition
