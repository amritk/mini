...
Fix every defect found in the pre-alpha audit (`docs/mini-lynx-audit.md`), and close the parity gaps against `@amritk/mini`. Pre-alpha, so the breaking pieces ride a minor.
