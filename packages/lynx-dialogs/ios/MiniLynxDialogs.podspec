Pod::Spec.new do |s|
  s.name = 'MiniLynxDialogs'
  s.version = '0.1.0'
  s.summary = 'Native date pickers and action sheets for Lynx'
  s.homepage = 'https://github.com/amritk/mini/tree/main/packages/lynx-dialogs'
  s.license = { :type => 'MIT' }
  s.author = 'amritk'
  ...
  # 13.0 for `UIScene`, which is how the key window is found. The wheels style
  # and the sheet detents want newer and are guarded at their call sites.
  s.platform = :ios, '13.0'
  ...
  # No `s.frameworks`: UIKit and Foundation come with every iOS pod, and there
  # is nothing else here. `@amritk/lynx-location` names CoreLocation because
  # CoreLocation is not one of those.
end
