/**
 * @amritk/mini-native — a signals runtime for Lynx, with no virtual tree.
 *
 ...
 * what this gets by construction. See `docs/mini-native-lynx-runtime.md` §4
 * for what that costs as well as what it buys.
 *
 * @example
 * ```tsx
 * import { globalEngine, mount, pageElement, setEngine, signal } from '@amritk/mini-native'
 *
