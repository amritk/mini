...
/**
 * Parses a `?a=1&b=2` search string into a flat record, so a screen can read
 * `route().query.page` directly.
 *
 ...
 * pure. `@amritk/mini` can and does use it, because its consumer is a browser
 * by definition.
 *
 ...
 * matching how a form's last field write wins.
 */
