# mini-lynx — js-framework-benchmark (keyed)

A keyed [js-framework-benchmark](https://github.com/krausest/js-framework-benchmark)
implementation in [`@amritk/mini-lynx`](../../README.md), mirroring
...
`@amritk/mini-lynx/testing`, whose operations are array splices on plain
...
```bash
bun run --filter='@amritk/mini-lynx' test   # includes this example's test
```
