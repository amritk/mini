...
export type MatchProps = {
  ...
  children: LynxElement | (() => LynxElement)
}
 ...
 *
 * The carrier is a plain object cast to `LynxElement`, not a real element from
